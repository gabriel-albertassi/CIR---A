...
- **REGRA DE PÁGINA ÚNICA (PDC + ETIQUETA):** O anexo (PDC) deve ser inserido como imagem centralizada (máx 500x650px) e a etiqueta deve vir logo abaixo, na mesma folha, com margens de 720 DXA em todos os lados.
